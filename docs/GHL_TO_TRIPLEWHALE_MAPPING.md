...
- [ ] Implement Cloudflare Worker to receive GHL webhooks and transform to TW format
- [ ] Configure GHL workflow to trigger on `Product Sale on Call` field population
- [ ] Test with sample transactions before enabling for all sales
- [ ] Consider dual-routing attribution data to Meta CAPI for improved coverage
- [ ] Add error handling for missing fields or malformed data
...
**API Key:** `5d16b4ce-45ae-4cfc-a385-4c16358579a1`
